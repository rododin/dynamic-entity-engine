...
/**
 * Introduces a set of <code>{@link ru.rododin.dynamic_entity_engine.entity.Property}</code> definitions to be used
 * together with <code>{@link ru.rododin.dynamic_entity_engine.demo.unit.Unit}</code>s and
 * <code>{@link ru.rododin.dynamic_entity_engine.demo.unit.UnitDefinition}</code>s.
 * <p/>
 * Each <code>UnitPropertyDefinition</code> defines the property name by its own enum constant name
 * and defines the property
 * <code>{@link ru.rododin.dynamic_entity_engine.entity.PropertyDescriptor#getValueClass() value class}</code>
 * <p/>
 * Please note, it doesn't define the property
 * <code>{@link ru.rododin.dynamic_entity_engine.entity.PropertyDescriptor#getDefaultValue() default value}</code>.
 * <p/>
...
public enum UnitPropertyDefinition
{
   ...
   * @see ru.rododin.dynamic_entity_engine.entity.PropertyDescriptor#getValueClass()
